...
var cordovaPlugins = ['org.apache.cordova.device', 'cordova-plugin-whitelist', 'org.apache.cordova.splashscreen', 'cordova-plugin-inappbrowser','https://github.com/Glitchbone/CordovaYoutubeVideoPlayer.git'];
...
gulp.task('build-html-cordova', function () {
    ...
    gulp.src('./assets/**/*')
        .pipe(gulp.dest('./build-cordova/www/assets'));
});
